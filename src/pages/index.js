  ...
  return (
    <Layout>
      ...
      <Icons
        ...
        iconSizes={["48", "48", "48"]}
      />
      <FeaturedImageBannerLarge
        data={data.allContentfulFeaturedImageBannerLarge}
      />
      <SectionHeader title={pageText.sectionHeaderTwo} />
      {galleryPage.map((gallery, index) => {
        const alignment = index % 2 === 0 ? "left" : "right"
        return <GalleryHeader align={alignment} data={gallery.node} />
      })}
      <Button
        content={pageText.portfolioButton}
        to="/portfolio/"
        pos={true}
      ></Button>
      <FeaturedImageBannerSmall
        data={data.allContentfulFeaturedImageBannerSmall}
      />
      <HomeBlogSection />
      <SectionHeader title={pageText.sectionHeaderThree} />
      <ContactSection
        content={pageText.contactSectionContent.contactSectionContent}
      />
    </Layout>
  )
}
